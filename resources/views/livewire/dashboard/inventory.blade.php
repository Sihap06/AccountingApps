       ...
       <div class="flex flex-wrap -mx-3 mt-6">
           <div class="flex-none w-full max-w-full px-3">
               <div
                   ...
                   <div
                       class="flex justify-end p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                       <button
                       ...
                       <x-slot name="content">
                           <form>
                               ...
                               <div class="relative mb-12" data-te-input-wrapper-init>
                                   <x-ui.input name="name" id="name" label="Nama" />
                               </div>
                               <div class="relative mb-12" data-te-input-wrapper-init>
                                   <x-ui.input name="harga" id="harga" label="Harga" />
                               </div>
                               <div class="relative mb-12" data-te-input-wrapper-init>
                                   <x-ui.input name="stok" id="stok" label="Stok" />
                               </div>

                               <x-ui.button type="submit" title="Submit" color="primary" />
                           </form>
                       </x-slot>
                   </x-ui.modal>
                                       ...
                                       <td
                                           ...
                                           <div class="flex px-2 py-1">
                                               ...
                                               <div class="flex flex-col justify-center">
                                                   <h6 class="mb-0 text-sm leading-normal dark:text-white">John Michael
                                                   </h6>
                                                   <p
                                   ...
                                   <tr>
                                       <td
                                           ...
                                           <div class="flex px-2 py-1">
                                               ...
                                               <div class="flex flex-col justify-center">
                                                   <h6 class="mb-0 text-sm leading-normal dark:text-white">Michael Levi
                                                   </h6>
                                                   <p
                                                       class="mb-0 text-xs leading-tight dark:text-white dark:opacity-80 text-slate-400">
                                   ...
                                   <tr>
                                       <td
                                           ...
                                           <div class="flex px-2 py-1">
                                               ...
                                               <div class="flex flex-col justify-center">
                                                   <h6 class="mb-0 text-sm leading-normal dark:text-white">Richard Gran
                                                   </h6>
                                                   <p
                                                       class="mb-0 text-xs leading-tight dark:text-white dark:opacity-80 text-slate-400">
